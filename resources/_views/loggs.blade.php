        ...
        <div class="cont pt-5 maut">
            ...
            <form action="{{ route('searcher') }}" method="GET" autocomplete="off">
                <div class="row">
                    ...
                    <div class="col-3 df" id="datte" style="display:none">
                            <p>Desde: </p><input type="text" name="filtro3" id="checkout"/>
                            <p>Hasta: </p><input type="text" name="filtro4" id="checko"/>
                    </div>
                    <div class="col-2">
            ...
            <form class="form-horizontal" method="POST" action="{{ route('pdf') }}">
                ...
                <div class="row pt-5 justify-content-center">
                    ...
                    @endif
                    <div class="col-2">
                        <button class="abutton" type="submit">Generar PDF</button>
                    </div>
                </div>
            </form>
                ...
                <div class="col-2">
                    <form action="{{ route('sendemail') }}" method="GET">
                        @if(isset($f))
                            ...
                            <input type="hidden" name="f3" value="{{ $f3 }}"/>
                        @endif
                        <button class="abutton" type="submit">Enviar Email</button>
                    </form>
                </div>
            </div>
        </div>
