...
<body class="cbg">
    <div class="container pt-5">
        ...
        <div class="row justify-content-center pt-5">
            <div class="col-8">
                <h4 class="pb-5 cnt"><strong>ALUMNOS DEL CENTRO </strong></h4>
            </div>
            <div class="col-10 mb-3">
                <a class="abutton mb-5" href="{{ route('create') }}">Crear Alumno</a>
            </div>
            <div class="col-10">
                                            ...
                                            <div class="modal fade" id="exampleModal-{{$alumno->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a type="button" class="btn btn-xs btn-success" data-dismiss="modal">Cancelar</a>
                                                    </div>
                                                    </div>
                                                </div>
                                            </div>
