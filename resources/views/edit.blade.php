...
<body class="cbg">
    <div class="container pt-5">
        ...
        <div class="row justify-content-center pt-5">
            <div class="col-8 cnt">
                <h4 class="foredit lb"><strong>EDITAR ALUMNO</strong></h4>
            </div>
            <div class="col-8 pt-4 cnt">
                        <div class="panel-body">
                            <form class="form-horizontal" method="POST" action="{{ route('update', ['id' => $alumno->id]) }}">
                                {{ csrf_field() }}

                                <div class="form-group{{ $errors->has('code') ? ' has-error' : '' }}">
                                    <label for="code" class="col-md-4 control-label"><strong>Código</strong></label>

                                    <div class="col-6 marcnt">
                                        <input id="code" type="text" class="form-control" name="code" value="{{ (old('code') ? old('code') : $alumno->code) }}" required>
                                ...
                                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6 marcnt">
                                        <input id="name" type="text" class="form-control" name="name" value="{{ (old('name') ? old('name') : $alumno->name) }}" required>
                                ...
                                <div class="form-group{{ $errors->has('surname') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6 marcnt">
                                        <input id="surname" type="text" class="form-control" name="surname" value="{{ (old('surname') ? old('surname') : $alumno->surname) }}" required>
                                ...
                                <div class="form-group{{ $errors->has('birthDate') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6 marcnt">
                                        <input id="birthDate" type="date" class="form-control" name="birthDate" value="{{ (old('birthDate') ? old('birthDate') : $alumno->birthDate) }}" required>
                                ...
                                <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6 marcnt">
                                        <input id="password" type="password" class="form-control" name="password" value="{{ (old('password') ? old('password') : $user->password) }}" required>
